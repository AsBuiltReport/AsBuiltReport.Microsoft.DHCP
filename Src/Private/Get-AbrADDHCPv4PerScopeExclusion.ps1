function Get-AbrADDHCPv4PerScopeExclusion {
    <#
    .SYNOPSIS
    ...
    process {
        $DHCPScopeExclusion = Get-DhcpServerv4ExclusionRange -CimSession $TempCIMSession -ComputerName $Server -ScopeId $Scope | Sort-Object -Property 'StartRange'
